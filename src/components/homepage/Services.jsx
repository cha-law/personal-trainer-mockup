export default function Services() {
    return (
        <section className="flex flex-col gap-2 place-items-center text-center py-20">
            ...
            <p className="max-w-150 mb-8">I offer a range of personalised services, from creating customized workout plans to working with you and helping you achieve your goals</p>
