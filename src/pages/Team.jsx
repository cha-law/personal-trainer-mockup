export default function Team() {
    return (
        <section className="py-20 flex flex-col items-center">
            ...
            <div className="flex gap-8 place-items-center max-w-140 p-8 border border-gray-300 rounded-md shadow-md mt-8">
            ...
            <div className="flex flex-wrap place-items-center mt-8 gap-8 text-center">
